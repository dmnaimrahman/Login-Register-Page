...
Practice modern UI/UX design for authentication systems
...
🧠 How It Works
Login & Register forms are controlled using JavaScript
...
⚠️ Note:
This is a frontend-only demo — no database is connected.

🔮 Future Improvements
🔗 Backend integration (PHP / Node.js / Firebase)
🗄️ Database connection (MySQL / Firestore)
...
Naiyemur Rahman
CSE Dept · Leading University, Sylhet
